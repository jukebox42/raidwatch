...
const mods: Mod[] = [
  ...
  { name: "Harmonic Dexterity", hash: 1677180919, elements: [], all: true },
  ...
  { name: "Harmonic Holster", hash: 3969361392, elements: [], all: true },
  // === Loader ===
  ...
  { name: "Harmonic Loader", hash: 1702273159, elements: [], all: true },
  ...
  { name: "Harmonic Loader", hash: 2657604783, elements: [], all: true },
  // === Reserves ===
  ...
  { name: "Harmonic Reserves", hash: 1103878128, elements: [], all: true },
  ...
  { name: "Harmonic Reserves", hash: 1971149752, elements: [], all: true },
  // === Scavenger ===
  ...
  { name: "Harmonic Scavenger", hash: 877723168, elements: [], all: true },
  ...
  { name: "Harmonic Scavenger", hash: 2815817957, elements: [], all: true },
  // === Siphon ===
  ...
  { name: "Harmonic Siphon", hash: 3832366019, elements: [], all: true },
  // === Surge ===
  ...
  { name: "Harmonic Targeting", hash: 1891463783, elements: [], all: true },
  ...
  { name: "Harmonic Targeting", hash: 1305536863, elements: [], all: true },
  // === Unflinching Aim ===
  ...
  { name: "Unflinching Harmonic Aim", hash: 293178904, elements: [], all: true },
  ...
  { name: "Unflinching Harmonic Aim", hash: 3094620656, elements: [], all: true },
];
...
const verifyUsable = (socket: AppSocketType, weaponDamageTypes: DamageType[]) => {
...
export const analyzeWeaponDamageTypeSockets = (sockets: AppSocketType[], weaponDamageTypes: DamageType[]): AppSocketType[] => {
  return filterWeaponDamageTypeSockets(sockets)
    .map(s => {
      const isUsable = verifyUsable(s, weaponDamageTypes);
      return {
        ...s,
